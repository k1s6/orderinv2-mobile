...
import 'package:orderin/model/Product.dart';
import 'package:orderin/view/EditMenu.dart';

final GlobalKey<ScaffoldMessengerState> _scaffoldMessengerKey = GlobalKey<ScaffoldMessengerState>();

class PageSteak extends StatefulWidget {
  const PageSteak({super.key, required this.onShowMessage});
...
class _PageSteakState extends State<PageSteak> {
  ...
  Future<void> getDataProduct(BuildContext context) async {
    final String apiUrl = '${OrderinAppConstant.productgetURL}/steak';
  ...
  Future<List<Product>> productsfind(
    ...
    await getDataProductFind(context, "steak", valuekey);
    return listProd;
  }
  ...
  Widget _buildCard(String IDproduct, String name, String price, String image,
    ...
    return InkWell(
      onTap: () {
        widget.onShowMessage("STATUS: Inkwell Clicked ID $IDproduct"); // Gunakan callback
        Navigator.push(
          context,
          MaterialPageRoute(
